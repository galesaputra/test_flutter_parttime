...
class CInputText extends StatelessWidget {
  ...
  CInputText(
      ...
      this.maxLines,
      this.backgroundColor = CColor.backgroundGrey,
      ...
      this.radius = 30, this.initialValue});
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          hintStyle: const TextStyle(color: CColor.hintText),
